  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20 lg:mb-32">
          <div className={cn(
            ...
            sectionVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'
             ...
             <h2 id="about-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 md:mb-8 leading-tight">
          ...
          <div className={cn(
            'relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] bg-gray-100 transition-opacity duration-1000 delay-200',
            sectionVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'
          )}>
            <LazyImage 
        ...
        >
          <article className="bg-brand-light p-6 sm:p-8 md:p-12 lg:p-16 hover:bg-white transition-colors focus-within:bg-white focus-within:ring-2 focus-within:ring-brand-gold">
            <Target className="w-10 h-10 sm:w-12 sm:h-12 text-brand-gold mb-4 sm:mb-6 md:mb-8" strokeWidth={1} aria-hidden="true" />
            <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">Misión</h3>
          ...
          <article className="bg-brand-light p-6 sm:p-8 md:p-12 lg:p-16 hover:bg-white transition-colors focus-within:bg-white focus-within:ring-2 focus-within:ring-brand-gold">
            <Eye className="w-10 h-10 sm:w-12 sm:h-12 text-brand-gold mb-4 sm:mb-6 md:mb-8" strokeWidth={1} aria-hidden="true" />
            <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">Visión</h3>
            <p className="text-sm sm:text-base text-slate-600 font-light leading-relaxed mb-3 sm:mb-4">
